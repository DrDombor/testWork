--Исхожу из условия что у нас есть товары именно "молоко" и "сметана". Таблица с клиентами - Clients, таблица с покупками Purchases.
 ...
 where CustomerId not in (select CustomerId from Purchases where ProductName = 'ñìåòàíà') 
 and CustomerId in (select CustomerId from Purchases where ProductName = 'ìîëîêî') 
